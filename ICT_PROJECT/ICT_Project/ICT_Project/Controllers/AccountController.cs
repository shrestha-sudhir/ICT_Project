...
namespace ICT_Project.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string username, string password)
        {
            ...
            {
                var user = db.User.Where(a => a.UserName.Equals(username) && a.Password.Equals(password)).FirstOrDefault();
                ...
                if (user != null)
                {
                    ...
                    else if (userP.First() == 2)
                    {
                        return RedirectToAction("ZDHome", "Home");
                    }
                    return RedirectToAction("UMHome", "Home");
                }
                else
                {
